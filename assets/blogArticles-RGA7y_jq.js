import{c as p}from"./index-B9nqTxbc.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const b=p("Calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]),d=t=>{const e=t.trim().split(/\s+/).length;return Math.ceil(e/200)},v=t=>new Date(t).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),i=`# How to Build an Unstoppable Transition Offense
...
*Written by Chris Bernhard — Basketball Orbit*  
*© 2025 Basketball Orbit*
`,u={slug:"zoom-action",title:"Mastering the Zoom Action: The Most Versatile Trigger in Modern 5-Out Offense",excerpt:"Discover how the Zoom Action creates space, triggers decisions and unlocks high-percentage offense. Learn the principles, coaching cues and drills — plus a complete PDF guide to master it with small-sided games and the constraint-led approach.",author:"Chris Bernhard",category:"Offense",tags:["Zoom Action","5-Out","Basketball Drills","Small-Sided Games","Constraint Led Approach","Offensive Concepts"],heroImage:"/lovable-uploads/zoom-action-hero.webp",heroImageAlt:"Players on the Basketball court setting a screen",readTimeMinutes:d(r),content:r,publishDate:"2025-10-19",featured:!0,youtubeUrl:"https://youtu.be/u7dRADmLkZ4",related:[{title:"Zoom Action — Drills & Variations",link:"https://youtu.be/rTVDgsR5cV0"},{title:"Complete Zoom Action Guide (Free PDF)",link:"https://guide.bballorbit.com/zoom"},{title:"How to Build an Unstoppable Transition Offense",link:"/blog/transition-offense"}]},l=[f,u].sort((t,o)=>new Date(o.publishDate).getTime()-new Date(t.publishDate).getTime()),w=(t,o=3)=>{const e=l.find(n=>n.slug===t);return e?l.filter(n=>n.slug!==t).filter(n=>n.category===e.category||n.tags.some(s=>e.tags.includes(s))).sort((n,s)=>{const h=(n.category===e.category?2:0)+n.tags.filter(a=>e.tags.includes(a)).length;return(s.category===e.category?2:0)+s.tags.filter(a=>e.tags.includes(a)).length-h}).slice(0,o):[]};export{b as C,l as b,v as f,w as g};
