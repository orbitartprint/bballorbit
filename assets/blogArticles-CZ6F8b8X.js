import{c as u}from"./index-DArxKiQ5.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T=u("Calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]),s=t=>{const e=t.trim().split(/\s+/).length;return Math.ceil(e/200)},A=t=>new Date(t).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),r=`# How to Build an Unstoppable Transition Offense
...
*Written by Chris Bernhard — Basketball Orbit*  
*© 2025 Basketball Orbit*
`,v={slug:"small-sided-games-vs-traditional-drills",title:"Why I Stopped Running Traditional Drills – And What I Do Instead",excerpt:"Why traditional basketball drills often fail to transfer to games — and how small-sided games help coaches design practices that develop real decision-making, spacing, and player IQ.",author:"Chris Bernhard",category:"Coaching Philosophy",tags:["Small-Sided Games","Basketball Practice Design","Game-Based Coaching","Modern Basketball Coaching","Player Development"],heroImage:"/lovable-uploads/small-sided-games-vs-traditional-drills-hero.webp",heroImageAlt:"Girls playing basketball 1-on-1 in a gym",readTimeMinutes:s(c),content:c,publishDate:"2025-12-22",featured:!0,youtubeUrl:"",related:[{title:"The Constraints-Led Approach Revolution: Rethinking How We Coach Basketball",link:"/blog/constraints-led-approach"},{title:"The Ultimate SSG Playbook – 100+ Competitive, Game-Like Drills",link:"/ssg-playbook"},{title:"Get Free Coaching PDFs and Drill Resources",link:"/resources"}]},h=`# How to Break Any Press in Basketball (Without Memorizing Plays)
...
`,w={slug:"press-break",title:"How to Break Any Press in Basketball (Without Memorizing Plays)",excerpt:"A principle-based approach to breaking any full-court press in basketball — without memorizing set plays. Learn how to prepare your players to make better decisions under pressure.",author:"Chris Bernhard",category:"Offense",tags:["Press Break","Full Court Press","Basketball Strategy","Decision Making","Spacing","Transition Offense","Offensive Concepts"],heroImage:"/lovable-uploads/press-break-hero.webp",heroImageAlt:"Players on the Basketball court trapping the offense player",readTimeMinutes:s(h),content:h,publishDate:"2026-01-18",featured:!0,youtubeUrl:"https://youtu.be/I9q8LFG6rpk",related:[{title:"How to Break Any Press (Free PDF)",link:"https://guide.bballorbit.com/press-break"},{title:"How to Build an Unstoppable Transition Offense",link:"/blog/transition-offense"}]},p=[f,b,y,v,w].sort((t,a)=>new Date(a.publishDate).getTime()-new Date(t.publishDate).getTime()),C=(t,a=3)=>{const e=p.find(n=>n.slug===t);return e?p.filter(n=>n.slug!==t).filter(n=>n.category===e.category||n.tags.some(o=>e.tags.includes(o))).sort((n,o)=>{const g=(n.category===e.category?2:0)+n.tags.filter(i=>e.tags.includes(i)).length;return(o.category===e.category?2:0)+o.tags.filter(i=>e.tags.includes(i)).length-g}).slice(0,a):[]};export{T as C,p as b,A as f,C as g};
