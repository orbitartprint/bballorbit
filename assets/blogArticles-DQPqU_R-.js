import{c as m}from"./index-BUpW_XZi.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v=m("Calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]),i=t=>{const e=t.trim().split(/\s+/).length;return Math.ceil(e/200)},w=t=>new Date(t).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),r=`# How to Build an Unstoppable Transition Offense
...
`,f={slug:"constraints-led-approach",title:"The Constraints-Led Approach Revolution: Rethinking How We Coach Basketball",excerpt:"Discover how modern coaching is shifting from control to creativity. The Constraints-Led Approach (CLA) blends science, intuition, and real-game learning — transforming how players think, adapt, and perform.",author:"Chris Bernhard",category:"Coaching Philosophy",tags:["Constraints Led Approach","Ecological Dynamics","Skill Acquisition","Modern Coaching","Basketball Learning"],heroImage:"/lovable-uploads/constraints-led-approach-hero.webp",heroImageAlt:"Coach guiding basketball players in a dynamic practice setting",readTimeMinutes:i(c),content:c,publishDate:"2025-11-30",featured:!0,youtubeUrl:"",related:[{title:"4 Drills to Train Decision-Making in Basketball",link:"https://youtu.be/DTqeh4D-agI"},{title:"Principles Over Rules: The Foundation of Modern Coaching",link:"https://transformingbball.com/principles-over-rules/"},{title:"Get Free Coaching PDFs and Drill Resources",link:"/resources"}]},d=[g,u,f].sort((t,o)=>new Date(o.publishDate).getTime()-new Date(t.publishDate).getTime()),k=(t,o=3)=>{const e=d.find(n=>n.slug===t);return e?d.filter(n=>n.slug!==t).filter(n=>n.category===e.category||n.tags.some(s=>e.tags.includes(s))).sort((n,s)=>{const p=(n.category===e.category?2:0)+n.tags.filter(a=>e.tags.includes(a)).length;return(s.category===e.category?2:0)+s.tags.filter(a=>e.tags.includes(a)).length-p}).slice(0,o):[]};export{v as C,d as b,w as f,k as g};
